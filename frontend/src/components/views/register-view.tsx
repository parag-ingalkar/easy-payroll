    ...
    <div className="min-h-screen flex flex-col bg-background">
      <div className="flex-1 flex flex-col justify-center px-6 py-10 max-w-md mx-auto w-full">
        <button
          ...
          className="flex items-center gap-1 text-sm text-graphite/60 hover:text-graphite mb-6 self-start"
        >
        ...
        <div className="bg-porcelain rounded-2xl border border-border/60 shadow-sm p-6 pp-animate-in">
          <h1 className="text-xl font-semibold text-graphite">Create owner account</h1>

          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-5">
            <div className="space-y-1.5">
              <Label htmlFor="name">Your name</Label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-graphite/40" />
                <Input
                  id="name"
                  className="pl-9"
